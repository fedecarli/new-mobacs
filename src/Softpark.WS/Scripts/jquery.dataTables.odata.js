...
function fnServerOData(sUrl, aoData, fnCallback, oSettings) {
    ...
    $.each(oSettings.aoColumns, function (i, value) {
        var sFieldName = (value.sName !== null && value.sName !== "") ? value.sName : ((typeof value.oData === 'string') ? value.oData : (
            (value.sName !== null && value.sName !== "") ? value.sName : ((typeof value.mData === 'string') ? value.mData : null)));
    ...
    if (oSettings.oFeatures.bServerSide) {
        ...
        $.each(oSettings.aoColumns,
            function (i, value) {
                ...
                var sFieldName = value.sName || value.oData || value.mData;
                ...
                if ((oParams.sSearch !== null && oParams.sSearch !== "" || columnFilter !== null && columnFilter !== "") && value.bSearchable) {
                    ...
                    case 'html':
                        ...
                        if (oParams.sSearch !== null && oParams.sSearch !== "" && typeof oParams.sSearch !== 'undefined')
                        {
                            // asFilters.push("substringof('" + oParams.sSearch + "', " + sFieldName + ")");
                            // substringof does not work in v4???
                            console.log(oParams);
                            asFilters.push("indexof(" + sFieldName + ", '" + oParams.sSearch.toLocaleLowerCase() + "') gt -1");
                        }

                        if (columnFilter !== null && columnFilter !== "" && typeof columnFilter !== "undefined") {
                            asColumnFilters.push("indexof(" + sFieldName + ", '" + columnFilter.toLocaleLowerCase() + "') gt -1");
                        }
                        break;
                    ...
                    case 'numeric':
                        ...
                        if (columnFilter !== null && columnFilter !== "" && columnFilter !== "~" && typeof columnFilter !== "undefined") {
                            asRanges = columnFilter.split("~");
                            if (asRanges[0] !== "" && typeof asRanges[0] !== "undefined") {
                                asColumnFilters.push("(" + sFieldName + " gt " + fnFormatValue(asRanges[0]) + ")");
                            }

                            if (asRanges[1] !== "" && typeof asRanges[1] !== "undefined") {
