...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public partial class ProfCidadaoVincAgendaProd
{

    public int IdAgendaProd { get; set; }

    public int IdVinc { get; set; }

    public Nullable<bool> AgendamentoMarcado { get; set; }

    public System.DateTime DataAgendadamento { get; set; }
